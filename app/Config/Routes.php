...
$routes->get('/myCart', 'CartController::index');
$routes->post('cartController/checkoutAction', 'CartController::checkoutAction');
$routes->get('/checkout', 'CartController::checkout');
$routes->get('/success', 'CartController::success');
$routes->get('/cancel', 'CartController::cancel');
$routes->get('/payment', 'CartController::payment');
$routes->get('/takepayment', 'CartController::takepayment');
$routes->post('cartController/addValue', 'CartController::addValue');
$routes->post('cartController/clearArray', 'cartController::clearArray');
