...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-1">
                <a href="<?php echo base_url('myCart'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;&nbsp;<span id="arrayDisplay"><?php echo $catValues; ?></span></a>
            </div>
            <div class="col-sm-1">
            ...
            ?>
                    <div class="col-sm-4" style="">
                        <div class="card"><br />
                            ...
                            <p><button type="button" onclick="addValue(<?php echo $productsModel[$key]['productId']; ?>)">Add to Cart</button></p>
                        </div>
                    </div>
                    <?php
                    $i++;
